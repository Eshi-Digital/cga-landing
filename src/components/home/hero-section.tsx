  ...
  return (
    <div className="bg-hero h-[90vh] bg-no-repeat bg-cover flex items-center justify-center py-28">
      <div className="flex flex-col gap-5 justify-center items-center">
        <div className="text-white text-4xl font-PoiretOne-Regular">
          We Are Creative
        </div>
        <div className="text-white font-PoiretOne-Regular text-4xl">
          Commercial Graduates Association
        </div>
        <div className="text-white font-poppins-light text-md">
